...
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 38 ->
    yystate(16, Ics, Line, Tlen+1, 15, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 40 ->
    yystate(16, Ics, Line, Tlen+1, 15, Tlen);
...
yystate(13, Ics, Line, Tlen, _, _) ->
    {16,Tlen,Ics,Line,13};
yystate(12, [113|Ics], Line, Tlen, _, _) ->
    yystate(20, Ics, Line, Tlen+1, 14, Tlen);
yystate(12, [95|Ics], Line, Tlen, _, _) ->
    yystate(3, Ics, Line, Tlen+1, 14, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(3, Ics, Line, Tlen+1, 14, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 112 ->
    yystate(3, Ics, Line, Tlen+1, 14, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 114, C =< 122 ->
    yystate(3, Ics, Line, Tlen+1, 14, Tlen);
...
-file("src/elixir_lexer.xrl", 56).
yyaction_0(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("src/elixir_lexer.xrl", 57).
yyaction_1(TokenChars, TokenLine) ->
     { token, { block, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/elixir_lexer.xrl", 58).
yyaction_2(TokenChars, TokenLine) ->
     { token, { brackets, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/elixir_lexer.xrl", 59).
yyaction_3(TokenChars, TokenLine) ->
     { token, { argsbegin, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/2}).
-file("src/elixir_lexer.xrl", 60).
yyaction_4(TokenChars, TokenLine) ->
     { token, { comment, TokenLine, TokenChars } } .

-compile({inline,yyaction_5/2}).
-file("src/elixir_lexer.xrl", 61).
yyaction_5(TokenChars, TokenLine) ->
     { token, { define, TokenLine, TokenChars } } .

-compile({inline,yyaction_6/2}).
-file("src/elixir_lexer.xrl", 62).
yyaction_6(TokenChars, TokenLine) ->
     { token, { directive, TokenLine, TokenChars } } .

-compile({inline,yyaction_7/2}).
-file("src/elixir_lexer.xrl", 63).
yyaction_7(TokenChars, TokenLine) ->
     { token, { argsend, TokenLine, TokenChars } } .

-compile({inline,yyaction_8/2}).
-file("src/elixir_lexer.xrl", 64).
yyaction_8(TokenChars, TokenLine) ->
     { token, { eol, TokenLine, TokenChars } } .

-compile({inline,yyaction_9/2}).
-file("src/elixir_lexer.xrl", 65).
yyaction_9(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, TokenChars } } .

-compile({inline,yyaction_10/2}).
-file("src/elixir_lexer.xrl", 66).
yyaction_10(TokenChars, TokenLine) ->
     { token, { module, TokenLine, TokenChars } } .

-compile({inline,yyaction_11/2}).
-file("src/elixir_lexer.xrl", 67).
yyaction_11(TokenChars, TokenLine) ->
     { token, { nullarg, TokenLine, TokenChars } } .

-compile({inline,yyaction_12/2}).
-file("src/elixir_lexer.xrl", 68).
yyaction_12(TokenChars, TokenLine) ->
     { token, { pointer, TokenLine, TokenChars } } .

-compile({inline,yyaction_13/2}).
-file("src/elixir_lexer.xrl", 69).
yyaction_13(TokenChars, TokenLine) ->
     { token, { punctuation, TokenLine, TokenChars } } .

-compile({inline,yyaction_14/2}).
-file("src/elixir_lexer.xrl", 70).
yyaction_14(TokenChars, TokenLine) ->
     { token, { identifier, TokenLine, TokenChars } } .

-compile({inline,yyaction_15/2}).
-file("src/elixir_lexer.xrl", 71).
yyaction_15(TokenChars, TokenLine) ->
     { token, { string, TokenLine, TokenChars } } .

-compile({inline,yyaction_16/2}).
-file("src/elixir_lexer.xrl", 72).
yyaction_16(TokenChars, TokenLine) ->
     { token, { syntax, TokenLine, TokenChars } } .

-compile({inline,yyaction_17/2}).
-file("src/elixir_lexer.xrl", 73).
yyaction_17(TokenChars, TokenLine) ->
